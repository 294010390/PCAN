...
class PCANBasic:
    ...
    def Initialize(
        ...
        try:
            ...
            print
            "Exception on PCANBasic.Initialize"
            raise
    ...
    def Uninitialize(
        ...
        try:
            ...
            print
            "Exception on PCANBasic.Uninitialize"
            raise
    ...
    def GetStatus(
        ...
        try:
            ...
            print
            "Exception on PCANBasic.GetStatus"
            raise
    ...
    def WriteFD(
        ...
        try:
            ...
            print
            "Exception on PCANBasic.WriteFD"
            raise
    ...
    def FilterMessages(
        ...
        try:
            ...
            print
            "Exception on PCANBasic.FilterMessages"
            raise
    ...
    def GetValue(
        ...
        try:
            ...
            print
            "Exception on PCANBasic.GetValue"
            raise
    ...
    def SetValue(
        ...
        try:
            ...
            print
            "Exception on PCANBasic.SetValue"
            raise
    ...
    def GetErrorText(
        ...
        try:
            ...
            print
            "Exception on PCANBasic.GetErrorText"
            raise
