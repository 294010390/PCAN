...
import tkinter.tix as Tix  ## TK extensions library  #??python3.6

import tkinter.messagebox as tkMessageBox  ## Simple-Messages library #??python3.6
import traceback  ## Error-Tracing library

import string  ## String functions
import tkinter.font as tkFont  ## Font-Management library #??python3.6
...
class PCANBasicExample(object):
    ...
    def InitializeBasicComponents(self):
        ...
        if IS_WINDOWS:
            self.m_PARAMETERS = {'USBs Device Number': PCAN_DEVICE_NUMBER, 'USB/PC-Cards 5V Power': PCAN_5VOLTS_POWER,
                                 ...
                                 'FD Capability': PCAN_CHANNEL_FEATURES,
    ...
    def InitializeConfigurationWidgets(self):
        ...
        self.nudDeviceId = Spinbox(self.gbParameters, width=15, state=DISABLED, from_=0, to=0x7FF,
                                   textvariable=self.m_DeviceIdNUD)
    ...
    def InitializeReadingWidgets(self):
        ...
        if IS_WINDOWS:
            self.m_ListColSpace = [10, 10, 7, 6, 8, 20]
        else:
            self.m_ListColSpace = [10, 10, 7, 8, 13, 30]
    ...
    def CenterTheWindow(self):
        ...
        self.m_Parent.geometry("{0}x{1}".format(self.m_Width,
                                                        self.m_Height))
